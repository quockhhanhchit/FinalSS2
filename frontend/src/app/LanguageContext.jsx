...
const TRANSLATIONS = [
  ...
  ["Tóm tắt tuần", "Weekly summary"],
  ["Nhận xét của AI tuần này", "This week's AI insights"],
  ["Thực đơn đã được cập nhật bởi AI", "Your meal plan was updated by AI"],
  ["Theo dõi cân nặng", "Weight tracking"],
  ["8 giờ", "8 hours"],
  ["2,5 lít", "2.5 liters"],
  ["Yến mạch chuối", "Oatmeal with Banana"],
  ["Bánh mì trứng", "Egg Sandwich"],
  ["Sữa chua Hy Lạp với trái cây", "Greek Yogurt Bowl"],
  ["Cháo gà", "Chicken Congee"],
  ["Cơm tấm sườn", "Com tam suon"],
  ["Cơm gà rau củ", "Chicken Rice with Vegetables"],
  ["Bún bò trộn rau", "Beef Noodle Salad"],
  ["Cơm gạo lứt đậu hũ", "Tofu Brown Rice Bowl"],
  ["Cơm cá hồi", "Salmon Rice Bowl"],
  ["Bún thịt nạc", "Lean Pork Vermicelli"],
  ["Gà nướng khoai lang", "Grilled Chicken Sweet Potato"],
  ["Bò xào bông cải", "Stir-fried Beef and Broccoli"],
  ["Cá áp chảo với cơm", "Pan-seared Fish with Rice"],
  ["Mì Ý thịt nạc", "Turkey Pasta"],
  ["Canh đậu hũ trứng rau củ", "Egg Tofu Vegetable Soup"],
  ["Cuốn salad gà", "Chicken Salad Wrap"],
  ["Sữa chua Hy Lạp", "Greek Yogurt"],
  ["Hộp trái cây", "Fruit Box"],
  ["Sinh tố whey protein", "Whey Protein Shake"],
  ["Trứng luộc", "Boiled Eggs"],
  ["Bánh mì bơ đậu phộng", "Peanut Butter Toast"],
  ["Sữa và chuối", "Milk and Banana"],
  ["Nhảy jumping jack", "Jumping Jacks"],
  ["Chạy nâng cao đùi", "High Knees"],
  ["Bật nhảy squat", "Squat Jumps"],
  ["Leo núi tại chỗ", "Mountain Climbers"],
  ["Aerobic cơ bản", "Basic Aerobics"],
  ["Đi bộ nhanh quanh nhà", "Fast Walk Around Home"],
  ["Leo cầu thang bộ", "Stair Climbing"],
  ["Cardio nhẹ ít tác động", "Low-impact Cardio Flow"],
  ["Chống đẩy", "Push-ups"],
  ["Squat tay không", "Bodyweight Squats"],
  ["Gập bụng", "Crunches"],
  ["Nâng hông", "Glute Bridges"],
  ["Chạy máy biến tốc", "Treadmill Intervals"],
  ["Nước rút trên xe đạp spin", "Spin Bike Sprints"],
  ["Chèo thuyền biến tốc", "Rowing Machine Intervals"],
  ["Battle rope ngắt quãng", "Battle Rope Intervals"],
  ["Đi bộ dốc trên máy chạy bộ", "Incline Treadmill Walk"],
  ["Đạp xe tốc độ đều", "Steady Bike Ride"],
  ["Máy leo cầu thang", "Stairmaster"],
  ["Máy elliptical", "Elliptical Trainer"],
  ["Đẩy ngực với tạ đòn", "Bench Press"],
  ["Squat với tạ đòn", "Barbell Squat"],
  ["Kéo xà", "Pull-ups"],
  ["Đẩy vai với tạ đơn", "Dumbbell Press"],
  ["Kéo xô máy", "Lat Pulldown"],
  ["Đi bộ phục hồi", "Active Recovery Walk"],
  ["Chuỗi vận động linh hoạt", "Mobility Flow"],
  ["Giãn cơ sâu", "Deep Stretching"],
  ["Thở phục hồi", "Breathing Reset"],
  ["Khởi động", "Warm-up"],
  ["Thả lỏng", "Cool-down"],
  ["Đi bộ nhẹ để cơ thể duy trì vận động", "Easy walk to keep the body moving"],
  ["Vận động khớp nhẹ và giãn cơ động", "Gentle joint mobility and dynamic stretching"],
  ["Giãn cơ toàn thân chậm để phục hồi", "Slow full-body stretching for recovery"],
  ["Hít thở và thư giãn cường độ thấp", "Low-intensity breathing and relaxation"],
  ["Cardio nhẹ và giãn cơ động", "Light cardio and dynamic stretching"],
  ["Giãn cơ và hít thở", "Stretching and breathing"],
